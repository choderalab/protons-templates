#!/bin/bash
#BSUB -J his-background-calibration
#BSUB -n 1
#BSUB -R rusage[mem=8]
#BSUB -R span[hosts=1]
#BSUB -q gpuqueue
...
python /lila/home/rustenburg/amino_acid_calibrations/run_calibration.py his-background-calibration-results/settings.json
